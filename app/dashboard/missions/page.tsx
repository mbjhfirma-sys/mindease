...
const ALL_MISSIONS: Mission[] = [
  { id: "default_breathing",     title: "4-7-8 Breathing",              description: "Complete two rounds of 4-7-8 breathing to activate your parasympathetic nervous system and reduce stress.",       category: "breathing",   duration: 5, completed: false, activityType: "breathing" },
  { id: "default_journal",       title: "Daily Gratitude Entry",        description: "Write down three things you're grateful for today — no matter how small. Builds a positive thinking habit.",        category: "journaling",  duration: 5, completed: false, activityType: "gratitude" },
  { id: "default_meditation",    title: "Morning Mindfulness",          description: "Spend 10 minutes in guided breath-awareness meditation to start your day with clarity and calm.",                    category: "mindfulness", duration: 10, completed: false, activityType: "timer" },
  { id: "default_walk",          title: "Mindful Walk",                 description: "Take a 15-minute walk outside. Notice 5 things you see, 4 you hear, 3 you can touch — a grounding exercise.",      category: "movement",    duration: 15, completed: false, activityType: "walk" },
  { id: "default_checkin",       title: "Evening Check-in",            description: "Answer one reflection question: What challenged me today and how did I respond? Write freely for 5 minutes.",        category: "journaling",  duration: 5, completed: false, activityType: "reflection" },
  { id: "default_bodyscan",      title: "Body Scan Meditation",         description: "Slowly scan from head to toe, noticing sensations without judgment. Helps release tension.",                       category: "mindfulness", duration: 15, completed: false, activityType: "bodyscan" },
  { id: "default_affirmations",  title: "Daily Affirmations",           description: "Read three affirmations aloud in front of a mirror. Counter your self-critical inner voice.",                       category: "habit",       duration: 5, completed: false, activityType: "generic" },
  { id: "default_stretch",       title: "Morning Stretch Routine",      description: "10 minutes of gentle neck rolls, shoulder shrugs, and forward folds to release overnight tension.",                 category: "movement",    duration: 10, completed: false, activityType: "stretch" },
  { id: "default_grounding",     title: "5-4-3-2-1 Grounding",         description: "Name 5 things you see, 4 you hear, 3 you can touch, 2 you smell, 1 you taste. Anchors you to the present moment.", category: "mindfulness", duration: 5, completed: false, activityType: "walk" },
  { id: "default_social",        title: "Reach Out to Someone",        description: "Send a genuine message to a friend or family member. Social connection is one of the strongest predictors of wellbeing.", category: "social", duration: 15, completed: false, activityType: "social" },
  { id: "default_progressive",   title: "Progressive Muscle Relaxation",description: "Tense and release each muscle group from feet to face. 15 minutes that reduce physical anxiety symptoms.",          category: "breathing",   duration: 15, completed: false, activityType: "bodyscan" },
  { id: "default_worry",         title: "Worry Dump Journal",           description: "Write every worry on your mind without filtering. Then review: which are in your control?",                         category: "journaling",  duration: 10, completed: false, activityType: "worry" },
  { id: "default_screen",        title: "Tech-Free Break",             description: "Step away from all screens for 30 minutes. Read, draw, stretch, or sit in silence.",                                 category: "habit",       duration: 30, completed: false, activityType: "timer" },
  { id: "default_hydration",     title: "Mindful Hydration",           description: "Drink a full glass of water slowly, focusing on the sensation. Hydration directly impacts mood.",                    category: "habit",       duration: 5, completed: false, activityType: "generic" },
  { id: "default_selfcompassion",title: "Self-Compassion Moment",       description: "Write one paragraph treating yourself as you'd treat a struggling friend.",                                          category: "journaling",  duration: 10, completed: false, activityType: "self_compassion" },
  { id: "default_creative",      title: "Creative Expression",          description: "Spend 20 minutes drawing, colouring, writing poetry, or playing music — no goal or judgment.",                      category: "habit",       duration: 20, completed: false, activityType: "generic" },
  { id: "default_nature",        title: "Connect with Nature",         description: "Sit outside for 20 minutes without your phone. Natural settings lower cortisol.",                                    category: "movement",    duration: 20, completed: false, activityType: "timer" },
  { id: "default_strength",      title: "Positive Strengths List",      description: "Write 5 personal strengths or recent wins. Regularly recognizing competence builds resilience.",                     category: "journaling",  duration: 5, completed: false, activityType: "strength" },
  { id: "default_sleep",         title: "Sleep Hygiene Wind-Down",      description: "30 minutes before bed: dim lights, stop screens, do gentle stretching to signal your body it's time to rest.",     category: "habit",       duration: 30, completed: false, activityType: "timer" },
  { id: "default_values",        title: "Values Reflection",            description: "Name one core value important to you and write how you will honor it in today's actions.",                          category: "journaling",  duration: 10, completed: false, activityType: "values" },
];
