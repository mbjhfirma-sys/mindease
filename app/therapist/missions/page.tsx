...
const ACTIVITY_TYPES: { value: string; label: string; hint: string }[] = [
  ...
  { value: "thought_record",  label: "CBT thought record",   hint: "Thought + belief rating → evidence for/against → balanced view" },
  { value: "behavioral_activation", label: "Activity planning", hint: "Plan 3 activities + rate predicted pleasure" },
